...
<div class="agenda-container">
    ...
    <ul class="list-unstyled row">
        {#each Agenda as item, i}
            <li class="agenda-card col-10 { item.type === "Talk" ? 'talk' : '' }">
                <div class="agenda-details">
                    <span class="iterator">{ twoDigits(i + 1) }.</span>
                ...
                <div class="agenda-content">
                    {#if item.type === 'talk' }
                        ...
                        <h2 class="speaker-name">{ item.details.speaker.name }</h2>
                        ...
                        <h4 class="talk-title">{ item.details.title }</h4>
